...
export const Footer = ({ onOpenAbout }) => {
  ...
  return (
    <footer className="w-full py-8 border-t border-slate-200 bg-white text-slate-500 text-xs" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        
        <div className="flex items-center space-x-2">
          <span className="font-bold text-slate-900" style={{ fontFamily: "'Lexend', sans-serif" }}>SarkariDoc Studio</span>
        ...
        <div className="flex items-center space-x-3 text-slate-600">
          <button
            ...
            aria-label="Share SarkariDoc Studio app with friends"
          ...
          <button onClick={onOpenAbout} className="flex items-center space-x-1 hover:text-emerald-600" aria-label="100% Client-Side Privacy — learn more">
            <Shield className="w-3.5 h-3.5 text-emerald-600 flex-shrink-0" aria-hidden="true" />
