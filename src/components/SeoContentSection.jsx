...
import { HelpCircle, ShieldCheck, CheckCircle2, FileText, Zap, Award } from 'lucide-react';

export const SeoContentSection = () => {
  return (
    <section className="w-full py-12 border-t border-slate-800/80 bg-slate-950/60">
      <div className="max-w-5xl mx-auto px-4 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-5 rounded-2xl glass-card border border-slate-800">
            ...
            <h3 className="font-bold text-white text-base mb-1">Instant Browser Processing</h3>
          ...
          <div className="p-5 rounded-2xl glass-card border border-slate-800">
            ...
            <h3 className="font-bold text-white text-base mb-1">100% Privacy Guaranteed</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="p-5 rounded-2xl glass-card border border-slate-800">
            ...
            <h3 className="font-bold text-white text-base mb-1">Guaranteed Portal Acceptance</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800/80 space-y-2">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                When taking a signature photo on a phone, shadows often turn white paper gray. Enable our <strong>Auto Background Cleanup</strong> toggle when using any Signature preset to sharpen ink lines and convert backgrounds to 100% pure white.
              </p>
            </div>
