...
export const InstallPwaBanner = () => {
  ...
  return (
    <>
      ...
      <div 
        className="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:max-w-md z-50 animate-in slide-in-from-bottom duration-300"
        style={{ willChange: 'transform, opacity' }}
      >
        <div className="bg-slate-900 border border-slate-700/80 text-white p-3.5 rounded-2xl shadow-2xl backdrop-blur-xl flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-bold text-xs text-slate-100 flex items-center gap-1.5" style={{ fontFamily: "'Lexend', sans-serif" }}>
                SarkariDoc Studio
              </h4>
      ...
      {showIOSModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-md flex items-end sm:items-center justify-center p-4">
          <div 
            className="bg-white rounded-3xl p-6 max-w-sm w-full text-slate-900 shadow-2xl border border-slate-100 animate-in fade-in zoom-in-95 duration-200"
            style={{ willChange: 'transform, opacity' }}
          >
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 text-base" style={{ fontFamily: "'Lexend', sans-serif" }}>Install on iPhone / iPad</h3>
