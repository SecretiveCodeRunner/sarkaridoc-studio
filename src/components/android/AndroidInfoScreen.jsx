  ...
  return (
    <div className="space-y-4 px-4 py-3 pb-24 max-w-lg mx-auto select-none">
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-2 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/90 dark:border-slate-800 p-4 shadow-xs">
          <div className="flex items-center justify-between py-1.5 border-b border-slate-100 dark:border-slate-800">
            <div className="flex items-center space-x-2.5">
              <Cpu className="w-4 h-4 text-blue-600 dark:text-blue-400" />
              <div>
                <p className="text-xs font-bold text-slate-800 dark:text-white">MediaPipe Neural Portrait AI</p>
                <p className="text-[10px] text-slate-500 dark:text-slate-400">244 KB TFLite Model + SIMD WASM</p>
              </div>
            </div>
            <span className="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/60">
              Bundled
            </span>
          </div>
          ...
          <div className="flex items-center justify-between py-1.5 border-b border-slate-100 dark:border-slate-800">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-slate-800 dark:text-white">PDF.js WebAssembly Worker</p>
          ...
          <div className="flex items-center justify-between py-1.5">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-slate-800 dark:text-white">Local Canvas Binary Optimizer</p>
      ...
      <div className="space-y-2">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/90 dark:border-slate-800 p-4 shadow-xs space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Sparkles className="w-4 h-4 text-blue-600 dark:text-blue-400" />
              <span className="text-xs font-bold text-slate-900 dark:text-white">SarkariDoc Studio v1.0.0</span>
            </div>
            <span className="text-xs text-slate-500 dark:text-slate-400 font-medium">Native Android Release</span>
          </div>
          ...
          <button
            type="button"
            onClick={onShare}
            className="w-full py-3 rounded-2xl bg-blue-50 dark:bg-blue-950/60 hover:bg-blue-100 dark:hover:bg-blue-900/60 text-blue-700 dark:text-blue-300 text-xs font-bold flex items-center justify-center space-x-2 border border-blue-200 dark:border-blue-800/60 active:scale-95 transition-all"
          >
