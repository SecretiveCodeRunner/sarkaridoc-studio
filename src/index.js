/**
 * SarkariDoc Studio — Cloudflare Worker Entry Point
 * Processes API endpoints (e.g. POST /api/remove-bg) via Cloudflare Workers AI Edge GPUs,
 * and delegates static asset requests to env.ASSETS.
 */
